...
<head>
  <title>SDOP-Student Development Online Platform</title>
  <meta charset="utf-8" />
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <!-- Logo text or image -->
        <a class="navbar-brand" href="index.html">SDOP</a>
      ...
      <div class="navigation collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
	      ...
	      <li><a href="#parallax1">login</a></li>
          <li><a href="#parallax2">Checkit!!!</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div id="intro">
    <div class="intro-text">
      <div class="container">
        <div class="col-md-12">
          <div id="rotator">
            <h1><span class="1strotate">Student development platform, Experience a world of coding, Develop Your Skills</span></h1>
            <div class="line-spacer"></div>
            <p><span class="2ndrotate">SDOP, BE A PRO, CONQUER</span></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            ...
            <p>We provide you with the best coding platform for developing your skills.</p>
          </div>
        </div>
      </div>
      <div class="row wow fadeInUp">
        ...
        <div class="col-md-6 content">
          <h2>Walk into the world of professional coding</h2>
          <h3>Experience coding like never before</h3>
          <p>
            Develop your skills,earn money,meet new people,interact with MNC's across the globe,compete with other top talents and be the pro of coding.Come join us for a brand new adventure    
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="color-light">
            <form action="post">
            <h2 class="wow bounceInDown" data-wow-delay="0.5s"><button type="submit" class="sdcone" formaction="http://localhost/mini/stregistration/login.php">LOGIN AS STUDENT DEVOLOPER</button></h2>
            <h2 class="wow bounceInDown" data-wow-delay="1s"><button type="submit" class="sdcone" formaction="http://localhost/mini/cmpregistration/login.php">LOGIN AS COMPANY</button></h2>
            </form>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            <h2>Works</h2>
            <div class="heading-line"></div>
            <p>Experience coding like never before.</p>
          </div>
        </div>
      </div>
      <div class="row">
  ...
  <section id="parallax2" class="home-section parallax" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <ul class="clients">
            <li class="wow fadeInDown" data-wow-delay="0.3s"><a href="http://localhost/mini/homepage/studev.php">Click here to see the list of registered student devolopers</a></li><br/><br/>
            <li class="wow fadeInDown" data-wow-delay="0.6s"><a href="http://localhost/mini/homepage/company.php">Click here to see the list of registered Companies</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            <h2>Contact us</h2>
            <div class="heading-line"></div>
            <p>If you have any question or just want to say 'hello' to SDOP please fill out form below and we will be get in touch with you within 24 hours. </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInRight">
            ...
            <h5>Email us</h5>
            <p>
              alfarisselman@gmail.com<br />rasmikr41@gmail.com
            </p>
          </div>
        </div>
      </div>
