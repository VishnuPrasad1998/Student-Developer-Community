...
if (isset($_POST['reg_user'])) {
 ...
 // form validation: ensure that the form is correctly filled ...
  ...
  if (empty($cname)) { array_push($errors, "Company name is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO company(cname,email,address,about,services,username,password_1,password_2,cid) 
  			  VALUES('$cname', '$email' ,'$address','$about','$services','$username','$password_1','$password_2','$cid')";
